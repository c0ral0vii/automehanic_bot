...
Revision ID: f3780cd92af7
Revises:
Create Date: 2024-10-29 09:20:27.509017
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("ADMIN", "USER", "UNDEFINED", "CANCELLED", name="role"),
            nullable=False,
        ),
        sa.Column(
            "price_level",
            sa.Enum(
                "DEFAULT", "FIRST", "SECOND", "THIRD", "FOURTH", name="price_level"
            ),
            nullable=False,
        ),
        sa.Column("created", sa.DateTime(), nullable=False),
